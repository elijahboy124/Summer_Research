...
for data, model in zip(datas, models):
    for i in range(4):
        if i == 0:
            # select all features
            X = data.drop(columns=['id_patient', 'dementia'], errors='ignore')
        elif i == 1:
            # select features without CT data
            X = data.drop(columns=['id_patient', 'dementia', 'TBV', 'TIV', 'TBV/TIV', 'L_HC', 'R_HC', 'Combined_HC', 'HC/TIV'], errors='ignore')
        elif i == 2:
            # select features without ARC data
            X = data.drop(columns=['id_patient', 'dementia', 'Dementia Stay Days - ARC', 'Hospital Stay Days - ARC', 'Psycgeri Stay Days - ARC', 'Resthome Stay Days - ARC'], errors='ignore')
        elif i == 3:
            # select features without CT data or ARC data
            X = data.drop(columns=['id_patient', 'dementia', 'TBV', 'TIV', 'TBV/TIV', 'L_HC', 'R_HC', 'Combined_HC', 'HC/TIV', 'Dementia Stay Days - ARC', 'Hospital Stay Days - ARC', 'Psycgeri Stay Days - ARC', 'Resthome Stay Days - ARC'], errors='ignore')
        ...
        if data is data1:
            plot_path = f'C:\\Users\\ehay055\\OneDrive - The University of Auckland\\Desktop\\research\\model\\plots\\original\\{indexs[count]}.png'
        elif data is data2:
            plot_path = f'C:\\Users\\ehay055\\OneDrive - The University of Auckland\\Desktop\\research\\model\\plots\\cleaned\\{indexs[count]}.png'
        elif data is data3:
            plot_path = f'C:\\Users\\ehay055\\OneDrive - The University of Auckland\\Desktop\\research\\model\\plots\\spearman\\{indexs[count]}.png'
        elif data is data4:
            plot_path = f'C:\\Users\\ehay055\\OneDrive - The University of Auckland\\Desktop\\research\\model\\plots\\rfe\\{indexs[count]}.png'
...
df_output.to_excel(r"C:\Users\ehay055\OneDrive - The University of Auckland\Desktop\research\results\model_results_new1.xlsx")
